/**
 * Call Campaigns Analytics/KPIs Page
 */
        ...
        <table className="w-full text-sm">
          <thead className="bg-gray-50">
            <tr>
              ...
              <th className="px-4 py-3 text-right font-semibold text-gray-700">Calls Made</th>
          ...
          <tbody>
            {data.map((row, idx) => (
              <tr key={idx} className="border-b border-gray-100 hover:bg-gray-50">
                ...
                <td className="px-4 py-3 text-right">{formatNumber(row.totalCallsMade, 0)}</td>
...
const CallAnalyticsPage = () => {
  ...
  const fetchFilterOptions = useCallback(async () => {
    try {
      const response = await callCampaignsApi.getFilterOptions();
      setFilterOptions({
  ...
  const fetchAnalytics = useCallback(async () => {
    ...
    try {
      ...
      const response = await callCampaignsApi.getAnalytics(params);
  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Cold Calling Analytics</h1>
      ...
      <div className="mb-8">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
          <KpiCard
            ...
            value={formatNumber(overall.totalCallsMade, 0)}
